  ...
  Connection con;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					deletecompany frame = new deletecompany();
	...
	public deletecompany() throws SQLException {
		...
		JLabel lblName = new JLabel("DELETE COMPANY FORM");
		...
		t7.addActionListener(new ActionListener() {
											public void actionPerformed(ActionEvent ex) {
								                           ...
								                           try
														      	   {
														      	   String str="select * from company where id="+t7.getText()+"";
