...
public class updateadmin extends JFrame {
  Connection con;
	...
	public updateadmin() throws SQLException {
		...
		JLabel lblName = new JLabel("UPDATE ADMIN FORM");
		...
		t7.addActionListener(new ActionListener() {
											public void actionPerformed(ActionEvent ex) {
								                           ...
								                           try
														      	   {
														      	   String str="select * from admin where id="+t7.getText()+"";
		...
		JLabel lblGender = new JLabel("MOBILE   :");
        ...
        String str="select ID from admin";
      ...
      try
							   				...
							   				stmt.executeUpdate("UPDATE admin SET  name='" +t9.getText()
							                   +"', user='"+t1.getText()
							   				+"', pass='"+t2.getText()
							   			    +"', mob='"+t10.getText()+
							   				"'  WHERE ID = " +sel1 + " ");
							   ...
							   System.out.println("hello");
							   												 							   				...
							   												 							   				JOptionPane.showMessageDialog(null,"Changes in the record has been successfully save.","JPMS",JOptionPane.INFORMATION_MESSAGE);
							   												 											dispose();
