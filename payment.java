  ...
  Connection con;
	...
	public payment() throws SQLException {
		...
		t9.addActionListener(new ActionListener() {
													public void actionPerformed(ActionEvent ex) {
										                           ...
										                           try
																      	   {
																      	   String str="select * from application where id="+t7.getText()+"";
		...
		JLabel lblGender = new JLabel("AMOUNT   :");
		...
		JLabel lblCountry = new JLabel("MODE :");
        ...
        String str="select ID from payment";
   ...
   String s9 = t7.getText(); //username
	...
	try
        ...
        str5="insert into payment values('"+s9+"','"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"')";
